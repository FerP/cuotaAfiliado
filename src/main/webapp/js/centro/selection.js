...
moduloCentro.controller('CentroSelectionController', ['$scope', '$routeParams', 'serverService', '$location', 'sharedSpaceService',
    function ($scope, $routeParams, serverService, $location, sharedSpaceService) {
        ...
        $scope.ob = "centro";
        $scope.op = "selection";
        $scope.title = "Selección de centro";
        $scope.icon = "fa-user";
        ...
        $scope.dofilter = function () {
         ...
         /*Ojo que aquí hay que modificar objeto */
        $scope.go = function (num) {
            sharedSpaceService.getObject().obj_centro.id = num;
