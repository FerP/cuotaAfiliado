...
moduloMunicipio.controller('MunicipioSelectionController', ['$scope', '$routeParams', 'serverService', '$location', 'sharedSpaceService',
    function ($scope, $routeParams, serverService, $location, sharedSpaceService) {
        ...
        $scope.ob = "municipio";
        $scope.op = "selection";
        $scope.title = "Selección de municipio";
        $scope.icon = "fa-user";
        ...
        $scope.go = function (num) {
            sharedSpaceService.getObject().obj_municipio.id = num;
