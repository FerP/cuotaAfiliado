...
moduloMunicipio.controller('MunicipioPListController', ['$scope', '$routeParams', 'serverService', '$location',
    function ($scope, $routeParams, serverService, $location) {
        
        $scope.visibles={};
        $scope.visibles.id = true;
        $scope.visibles.nombre = true;       
        $scope.visibles.id_provincia= true;
        $scope.visibles.id_comarca= true;
       


        $scope.ob = "municipio";
        $scope.op = "plist";
        $scope.title = "Listado de municipios";
