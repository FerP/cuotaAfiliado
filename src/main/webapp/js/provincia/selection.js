...
moduloProvincia.controller('ProvinciaSelectionController', ['$scope', '$routeParams', 'serverService', '$location', 'sharedSpaceService',
    function ($scope, $routeParams, serverService, $location, sharedSpaceService) {
        ...
        $scope.ob = "provincia";
        $scope.op = "selection";
        $scope.title = "Selección de provincia";
        $scope.icon = "fa-user";
        ...
        $scope.go = function (num) {
            sharedSpaceService.getObject().obj_provincia.id = num;
