...
moduloCuota.controller('CuotaSelectionController', ['$scope', '$routeParams', 'serverService', '$location', 'sharedSpaceService',
    function ($scope, $routeParams, serverService, $location, sharedSpaceService) {
        ...
        $scope.visibles.importe = true;
        
        
        
        $scope.ob = "cuota";
        $scope.op = "selection";
        $scope.title = "Selección de cuota";
        ...
        $scope.go = function (num) {
            sharedSpaceService.getObject().obj_cuota.id = num;
