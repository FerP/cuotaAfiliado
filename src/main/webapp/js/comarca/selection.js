...
moduloComarca.controller('ComarcaSelectionController', ['$scope', '$routeParams', 'serverService', '$location', 'sharedSpaceService',
    function ($scope, $routeParams, serverService, $location, sharedSpaceService) {
        ...
        $scope.ob = "comarca";
        $scope.op = "selection";
        $scope.title = "Selección de comarca";
        $scope.icon = "fa-user";
        ...
        $scope.go = function (num) {
            sharedSpaceService.getObject().obj_comarca.id = num;
