...
public class ReciboAfiliadoBean implements GenericBean {    
    ...
    @Override
     public ReciboAfiliadoBean fill(ResultSet oResultSet, Connection pooledConnection, Integer expand) throws SQLException, Exception {
       if (expand > 0) {
